...
# 모델 클래스 개발 및 반영 순서
# 1) 모델 클래스 정의 시, models.Model 클래스 상속받아 모델클래스를 정의 (정의만 한다고 사용할 수 있는 것은 아님)
...
# 북마크를 저장할 모델 클래스
# URL이름(피란글씨), 클릭 시 넘어갈 URL주소
class Bookmark(models.Model): # 클래스 변수를 생성해 해당 모델클래스가 어떤 값들을 저장하는지 정의. (1)에 해당)
